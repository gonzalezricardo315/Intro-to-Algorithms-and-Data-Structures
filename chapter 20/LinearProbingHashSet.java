 ...
 */
public class LinearProbingHashSet<AnyType> extends AbstractCollection<AnyType> implements Set<AnyType>
{
    /**
     ...
     */
    public LinearProbingHashSet( Collection<? extends AnyType> other )
    {
